...
entrada = pd.DataFrame([[G1*4, G2*4, studytime, failures, absences, famsup, schoolsup, higher, internet, romantic, famrel, freetime, goout, Dalc, Walc, health]], columns=features)
...
st.write('La nota final aproximada esta entre :', nota_final-0.25 ,' y ',nota_final +0.25)

st.write('Porcentaje de acierto:', modelo_arbol_c.score(X_test, y_test) * 100, '%')
st.write('Porcentaje de acierto regression:', modelo_arbol_r.score( X_test_reg,y_test_reg) * 100, '%')
